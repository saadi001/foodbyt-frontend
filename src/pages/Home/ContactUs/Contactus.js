    ...
    <span class="relative text-white">Contact</span>
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-2 text-blue-500">cygbyte@gmail.com</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <h2 className="mt-4 text-lg font-medium text-gray-800 te">Chat</h2>
                        <p className="mt-2 text-gray-500 ">Message to our facebook page for your any problem.</p>
                        <a href='https://www.facebook.com/foodbytbd' className="mt-2 text-blue-500 ">https://www.facebook.com/foodbytbd</a>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-2 text-blue-500">+8801836530309</p>
                        <p className="mt-2 text-blue-500">+8801849289023</p>
                    </div>
                </div>                          
            </div>
        </section>
