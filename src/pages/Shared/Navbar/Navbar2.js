          ...
          <div className='px-5 md:px-8 lg:px-20 z-50'>
               <div className='py-2 flex justify-between items-center'>
                    ...
                    <Link to={'/'} className='bg-primary px-3 py-2 text-white rounded-3xl hidden lg:inline-block'>Go to home page</Link>
                         ...
                         <label htmlFor="my-drawer-2" className="cursor-pointer p-1 drawer-button lg:hidden"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
